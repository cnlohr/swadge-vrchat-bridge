...
Shader "HologramTreesV2"
{
	Properties
	{
		...
		_DefaultHologramColor("DefaultHologramColor", Color) = (1,1,1,0)
		_DiscoBallIntensity("DiscoBallIntensity", Float) = 2
		_DiscoBallDisc("DiscoBallDisc", Float) = 50
	...
	SubShader
	{
		...
		uniform float4 _DefaultHologramColor;
		uniform int _CCIndex;
		uniform float _IntensityAdd;
		uniform float _DiscoBallDisc;
		uniform float _DiscoBallIntensity;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 tex2DNode29 = UnpackNormal( tex2D( _RimNormalMap, ( ( ( Speed4 / 1000.0 ) * _Time ) + float4( i.uv_texcoord, 0.0 , 0.0 ) ).xy ) );
			float3 normalizeResult30 = normalize( i.viewDir );
			float dotResult33 = dot( tex2DNode29 , normalizeResult30 );
			float temp_output_45_0 = pow( ( 1.0 - saturate( dotResult33 ) ) , ( 10.0 - _RimPower ) );
			float Rim47 = temp_output_45_0;
			float temp_output_68_0 = ( i.uv_texcoord.y * _CCIndex );
			float Position1_g3 = temp_output_68_0;
			...
			float4 lerpResult74 = lerp( _DefaultHologramColor , localAudioLinkLerp1_g3 , saturate( ( localAudioLinkData1_g2 * 100.0 ) ));
			float4 blendOpSrc65 = ( ( HologramColor51 * ( ScanLines48 + Rim47 ) ) * _Intensity );
			float4 blendOpDest65 = lerpResult74;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 normalizeResult83 = normalize( ase_worldViewDir );
			float dotResult84 = dot( (WorldNormalVector( i , tex2DNode29 )) , normalizeResult83 );
			float temp_output_92_0 = saturate( dotResult84 );
			o.Emission = ( ( ( saturate( (( blendOpDest65 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest65 ) * ( 1.0 - blendOpSrc65 ) ) : ( 2.0 * blendOpDest65 * blendOpSrc65 ) ) )) * ( temp_output_92_0 + _IntensityAdd ) ) + ( pow( temp_output_92_0 , _DiscoBallDisc ) * _DiscoBallIntensity ) ).xyz;
...
Node;AmplifyShaderEditor.RangedFloatNode;2;20.41711,-822.2412;Float;False;Property;_Speed;Speed;1;0;Create;True;0;0;0;False;0;False;26;25;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-1238.691,530.5699;Float;False;Property;_ScanLines;Scan Lines;2;0;Create;True;0;0;0;False;0;False;3;6;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-613.0188,-77.64594;Float;False;Property;_RimPower;Rim Power;5;0;Create;True;0;0;0;False;0;False;5;7.57;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;49;-686.3889,-872.7424;Float;False;Property;_Hologramcolor;Hologram color;0;0;Create;True;0;0;0;False;0;False;0.3973832,0.7720588,0.7410512,0;0.01415092,1,0.9433002,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.IntNode;66;1042.203,-442.1353;Inherit;False;Property;_CCIndex;CCIndex;8;0;Create;True;0;0;0;False;0;False;1;1;False;0;1;INT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;50;1507.326,-854.0895;Inherit;False;47;Rim;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;54;2141.356,-821.2726;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;1981.809,-928.861;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;58;1760.441,-976.1682;Inherit;False;51;HologramColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;61;1442.688,-1042.329;Inherit;False;48;ScanLines;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;62;1763.747,-867.4424;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;63;1624.017,-723.4219;Float;False;Property;_Intensity;Intensity;6;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;85;3012.612,-388.9372;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;88;2544.749,-41.34295;Inherit;False;Property;_IntensityAdd;IntensityAdd;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;74;2110.076,-348.7376;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SaturateNode;71;1908.56,-215.9765;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3476.686,-789.8054;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;HologramTreesV2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.SaturateNode;92;2787.166,-330.1629;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;89;3280.127,-222.4706;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.PowerNode;90;3089.396,-113.3196;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;86;2882.664,-103.9255;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;82;2278.033,-133.7399;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;84;2662.554,-266.7559;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;83;2480.622,-176.9119;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldNormalVector;93;2326.68,-342.1107;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;3250.035,1.388306;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;95;3057.035,111.3883;Inherit;False;Property;_DiscoBallIntensity;DiscoBallIntensity;11;0;Create;True;0;0;0;False;0;False;2;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;91;2817.64,79.99825;Inherit;False;Property;_DiscoBallDisc;DiscoBallDisc;12;0;Create;True;0;0;0;False;0;False;50;24.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;75;1833.362,-74.0977;Inherit;False;Property;_DefaultHologramColor;DefaultHologramColor;10;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.1098039,0.7176471,0.6352941,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;97;1721.644,-460.9377;Inherit;False;AutoCorrelator;-1;;2;c08072cb66b844942884d88404654c86;0;1;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;59;1315.974,-424.4714;Float;False;Property;_Opacity;Opacity;3;0;Create;True;0;0;0;False;0;False;0.5;0.081;0;1;0;1;FLOAT;0
...
WireConnection;97;1;68;0
ASEEND*/
//CHKSM=C90A5EF664A9FB5AF0A07609E2050698D4EFC751